...
class AlphabetizeArgumentsRule extends LintRule<AlphabetizeArgumentsRule> {
  ...
  @override
  Visitor<AlphabetizeArgumentsRule, void> visitorFor(RuleContext context) =>
      _AlphabetizeArgumentsVisitor(this, context);

  @override
  void registerVisitor(
    RuleVisitorRegistry registry,
    Visitor<AlphabetizeArgumentsRule, void> base,
    AstVisitor<void> timed,
  ) {
    registry.addArgumentList(this, timed);
  }
}
